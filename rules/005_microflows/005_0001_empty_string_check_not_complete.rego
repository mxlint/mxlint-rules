...
#  severity: MEDIUM
#  rulenumber: 005_0001
#  remediation: Always check a string for empty based on != empty and != "".
#    The first one equals database NULL value, the latter one indicates a
#    truncated string.
...
errors contains error if {
	...
	error := sprintf(
		"[%v, %v, %v] Expression in Microflow '%v' has incomplete empty string check '%v'",
		[
