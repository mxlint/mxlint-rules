...
# description: Avoid using the style property, because this will make the life of your
#   UI designer a lot more complicated. It will be harder to overrule styles from
#   CSS file level.
# authors:
...
errors contains error if {
	...
	v != ""
	error := sprintf(
		"[%v, %v, %v] Form with name '%v' has inlined style property with value '%v'",
		[
