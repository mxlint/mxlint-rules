...
# description: There is no need to inherit from administration.account.
#   Administration.account may simply be extended, this is not a system module.
#   Avoid unnecessary inheritance as this has a negative effect on performance.
# authors:
...
errors contains error if {
	...
	error := sprintf(
		"[%v, %v, %v] Entity %v has generaralization of %v",
		[
