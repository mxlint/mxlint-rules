...
# description: The bigger the domain models, the harder they will be to maintain.
#   It adds complexity to your security model as well. The smaller the modules,
#   the easier to reuse.
# authors:
...
errors contains error if {
	...
	error := sprintf(
		"[%v, %v, %v] There are %v entities which is more than %v",
		[
